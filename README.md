...
- 🏆 **[ArenaCup26](https://github.com/hectoresen/ArenaCup26)** - A platform where users can predict all 104 FIFA World Cup matches, earn points based on correct predictions, climb a real-time leaderboard, and invite friends to compete head-to-head. This is not a betting service: there is no money involved and no material prizes — it's a prediction game designed to make the tournament more exciting and enjoyable with your friends.
